...
void CPP_CAN::CPP_CAN_Filter_Init() {
...
void CPP_CAN::CPP_CAN_Init(CAN_HandleTypeDef *hcan) {
    CPP_hcan = hcan;
    CPP_CAN_Filter_Init();
}

void CPP_CAN::CPP_CAN_Rx_Data() {
...
void CPP_CAN::CPP_CAN_Tx_Data(uint8_t TxData[], uint32_t CAN_id) {
