...
/* USER CODE BEGIN Header_LED_BTask */
/**
* @brief Function implementing the LED_B thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LED_BTask */
__weak void LED_BTask(void const * argument)
{
  /* USER CODE BEGIN LED_BTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END LED_BTask */
}
